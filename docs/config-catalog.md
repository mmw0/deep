...
Source: [`packages/ui/acp-agent/src/index.ts:32`](../packages/ui/acp-agent/src/index.ts)
...
Source: [`packages/core/agent-core/src/index.ts:50`](../packages/core/agent-core/src/index.ts)
