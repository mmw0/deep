...
Source: [`packages/ui/acp-agent/src/index.ts:53`](../packages/ui/acp-agent/src/index.ts)
...
Depends on: [`AgentLoopConfig`](#deepseek-aidsh-agent-loop) · [`SystemPromptConfig`](#deepseek-aidsh-system-prompt) · [`ToolsConfig`](#deepseek-aidsh-tools) · [`workspaceContext`](../packages/prompt/workspace-context/src/index.ts)
