...
Source: [`packages/ui/acp/src/index.ts:212`](../packages/ui/acp/src/index.ts)
...
Requires: `agents` · `userInteraction` · `tools` · `llm` · `systemPrompt` · `tokenMeter`
...
Source: [`packages/ui/tui/src/index.ts:126`](../packages/ui/tui/src/index.ts)
