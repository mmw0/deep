# RFC: Required cancellation through tool-reachable capability seams
...
**Migrate every capability in the implemented tool-registry PR.** Rejected because the transitive interface changes span independent capability families. Keeping this proposal separate preserves the implemented registry decision and lets each deep seam migrate with focused tests.
