...
| `fs/write-intent` | `waterfall` | [`packages/fs/fs/src/index.ts:52`](../packages/fs/fs/src/index.ts) | [`tool-fs`](../packages/fs/tool-fs) (`waterfall`) | [`fs-policy`](../packages/fs/fs-policy) |
