...
Pressure/overflow prunes before summaries; surface progress enables retry; cancellation wins ([RFC](rfc/implemented/architecture/2026-07-10-after-call-compaction-pressure-and-overflow-recovery.md)).
