...
| [`project-instructions`](../packages/prompt/project-instructions) | `prompt` | [`agent`](../packages/core/agent), [`fs`](../packages/fs/fs), [`llm`](../packages/llm/llm), [`paths`](../packages/util/paths) |
...
| [`acp-agent`](../packages/ui/acp-agent) | `ui` | [`acp`](../packages/ui/acp), [`agent-core`](../packages/core/agent-core), [`app-boot`](../packages/ui/app-boot), [`project-instructions`](../packages/prompt/project-instructions), [`session-persistence-jsonl`](../packages/session-persistence/session-persistence-jsonl) |
