...
flowchart TD
  ...
  pkg_compact_tool_result_prune --> pkg_mode
...
| [`compact-tool-result-prune`](../packages/compact/compact-tool-result-prune) | `compact` | [`llm`](../packages/llm/llm), [`mode`](../packages/mode/mode), [`session`](../packages/core/session) |
