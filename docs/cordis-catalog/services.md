...
Source: [`packages/bash/bash/src/index.ts:64`](../../packages/bash/bash/src/index.ts)
...
Source: [`packages/bash/tool-bash/src/index.ts:146`](../../packages/bash/tool-bash/src/index.ts)
