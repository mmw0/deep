...
export const zh = {
  ...
  'section.sessions': '会话',
  'menu.chatMode': '聊天',
  'menu.nixeWorkspace': 'NIXE · 智能体工作区',
  'menu.nixeCreating': '正在创建 NIXE…',
  ...
  'delete.desc': '将永久删除“{name}”：包括它的文件夹、全部会话与聊天记录。此操作不可撤销。',
  'delete.pending': '正在删除工作区…',
  'menu.fork': '分叉会话',
  'menu.archiveSession': '归档会话',
  'menu.deleteSession': '删除会话',
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除“{name}”及其全部聊天记录，包括服务器上的会话日志。此操作不可撤销、无法恢复。',
...
export const en = {
  ...
  'menu.chatMode': 'Chat',
  'menu.nixeWorkspace': 'NIXE · Agent workspace',
  'menu.nixeCreating': 'Creating NIXE…',
  ...
  'delete.desc': 'This permanently deletes “{name}” — its folder and ALL its sessions and chats. This cannot be undone.',
  'delete.pending': 'Deleting workspace…',
  'menu.fork': 'Fork session',
  'menu.archiveSession': 'Archive session',
  'menu.deleteSession': 'Delete chat',
  'delete.session': 'Delete chat',
  'delete.session.desc': 'This permanently deletes “{name}” and its entire chat history, including the session log on the server. This cannot be undone or recovered.',
  'delete.session.pending': 'Permanently deleting chat…',
