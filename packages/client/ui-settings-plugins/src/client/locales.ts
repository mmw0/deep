...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchDescription: 'The OpenRouter online search provider.',
  ...
  webSearchMaxUses: 'Max sources per search',
  webSearchMaxUsesHint: 'How many cited sources one search may return.',
}
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchTitle: '网页搜索',
  webSearchDescription: 'OpenRouter 在线搜索提供方。',
  webSearchApiKey: 'API Key',
  ...
  webSearchMaxUses: '单次搜索最多来源数',
  webSearchMaxUsesHint: '一次搜索最多返回多少个引用来源。',
}
