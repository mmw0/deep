...
/**
 * No runtime invariant: this model-facing adapter has no independent lifecycle stream; the
 * subprocess boundary's outcome IS the tool result the session log already captures.
 */
