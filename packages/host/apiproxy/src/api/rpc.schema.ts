...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('path-not-file'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-not-found'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-too-large'), message: z.string(), details: z.object({ path: z.string(), size: z.number() }) }),
