...
| [`session-query/`](session-query/README.md) | Session retrieval family: logical corpus, surface records, bounded exact reads, lineage, and event relationships | Product — stable surface |
