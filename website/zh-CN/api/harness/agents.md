...
[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L187)
...
[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L232)
...
[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L248)
...
[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L277)
...
[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L346)

### ctx.agents.reportStartFailure(id, error)
...
- `id` — the configured agent id that failed before publication.
- `error` — the normalized startup error.

**Returns** a disposer that clears this exact failure record.

[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L381)

### ctx.agents.getStartFailure(id)
...
- `id` — the configured agent id.

**Returns** the startup error, or undefined when the id has no retained failure.

[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L395)
...
[Source](https://github.com/deepseek-harness/deepseek-harness/blob/master/packages/core/agent/src/index.ts#L419)
