// Inlined bench-fixture — generated from fixtures/bench/matrix-sample.json.
// Renderer loads via file:// so a fetch() would require a custom IPC seam;
// inlining follows the same pattern as debug-fixtures.js.
//
// Regenerate whenever the source JSON changes:
//   node -e 'const fs=require("fs"); const j=fs.readFileSync("fixtures/bench/matrix-sample.json","utf8"); fs.writeFileSync("src/renderer/bench-fixture.js", "// Inlined bench-fixture …\n" + "const BENCH_FIXTURE_BATCH = " + j + ";\n\nif (typeof module !== "undefined" \&\& module.exports) module.exports = BENCH_FIXTURE_BATCH;\nif (typeof window !== "undefined") window.__dshBenchFixture = BENCH_FIXTURE_BATCH;\n")'

'use strict'

const BENCH_FIXTURE_BATCH = {
  "meta": {
