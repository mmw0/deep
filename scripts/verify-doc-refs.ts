 ...
 * `docs/architecture.md § Extending The Harness`. `verify-md-links` parses Markdown
 ...
 * `docs/architecture.md § Extending The Harness` — the section suffix is outside the
 ...
 * so trailing prose (`… .md § Extending The Harness`) is not swallowed into the path.
 */
